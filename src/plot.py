...
if __name__ == '__main__':
    ...
    # # fits = maze_fitness([trans], tm_timeout=100, states=['start'], target=maze, maze_sol=maze_sol)
    # # print(fits)
    # # t1 = time.time()
    # # total = t1-t0
    # plot_tape(trans, tm_timeout=100, target=maze, maze_sol=maze_sol, test_kwargs=[['Result']])
    # # print(fits)
